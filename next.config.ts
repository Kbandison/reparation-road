  ...
  images: {
    remotePatterns: [
      ...
      },
      {
        ...
        hostname: "nviahrhrupqvwyglaxlj.supabase.co",
        port: "",
        pathname: "/storage/v1/object/public/native-american-records/**",
      },
      {
        protocol: "https",
        hostname: "nviahrhrupqvwyglaxlj.supabase.co",
      ...
      },
      {
        ...
        hostname: "nviahrhrupqvwyglaxlj.supabase.co",
        port: "",
        pathname: "/storage/v1/object/public/slave-importation/**",
      },
      {
        protocol: "https",
        hostname: "nviahrhrupqvwyglaxlj.supabase.co",
        port: "",
        pathname: "/storage/v1/object/public/va-order-books/**",
      },
      {
        protocol: "https",
        hostname: "nviahrhrupqvwyglaxlj.supabase.co",
        port: "",
        pathname: "/storage/v1/object/public/slave-merchants/**",
      },
      {
        protocol: "https",
        hostname: "nviahrhrupqvwyglaxlj.supabase.co",
        port: "",
        pathname: "/storage/v1/object/public/slave-merchant-records/**",
      },
    ],
