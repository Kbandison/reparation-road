      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Unlock the power of historical research with our comprehensive
            collection of Black history records. Start your genealogical journey
            today.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              ...
              <div className="space-y-2">
                <div className="flex items-center text-gray-500">
                  ...
                  <span className="text-sm">
                    No access to historical data tables
                  </span>
                </div>
                <div className="flex items-center text-gray-500">
                  <X className="w-4 h-4 mr-2" />
          ...
          <div className="bg-white rounded-2xl shadow-xl border-2 border-brand-green p-8 relative">
            ...
            <div className="text-center mb-8">
              ...
              <div className="text-lg text-gray-600 mb-2 line-through">
                $14.99
              </div>
            ...
            >
              {user && profile?.subscription_status === "paid"
                ? "Current Plan"
                : "Upgrade to Premium"}
            </Button>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Access thousands of historical documents including slave
                compensation claims, emigration records, and census rolls.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Powerful search tools to help you find your ancestors and trace
                your family history through multiple historical collections.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Get guidance from genealogy experts and historians who
                specialize in African American family research.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <p className="text-gray-600">
                ...
                downgrade, your access will continue until the end of your
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <p className="text-gray-600">
                Premium members receive access to new historical records and
                collections monthly, with major updates quarterly.
              </p>
            </div>
          </div>
        </div>
