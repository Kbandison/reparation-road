        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Lost Friends: Minnesota
            </h1>
            <p className="text-lg text-white/90">
              Post-war family reunion advertisements from Minnesota, documenting formerly enslaved individuals searching for separated loved ones.
            </p>
          </div>
        </div>
      </div>
