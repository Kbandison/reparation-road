      ...
      <div className="bg-white rounded-lg shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-white border-b border-gray-200 p-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <BookmarkButton
              pageId={record.id}
              collectionName="Register of Free Persons - Hancock"
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                {/* Citation */}
                <RecordCitation
                  collectionName="Register of Free Persons - Hancock County"
                ...
                <RelatedRecords
                  ...
                  currentTable="register_free_persons_hancock"
                  searchTerms={{
                    name: record.name || undefined,
...
const WrappedRegisterFreePersonsHancockPage = () => {
  return (
...
export default WrappedRegisterFreePersonsHancockPage;
