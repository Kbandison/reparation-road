      ...
      <div className="bg-white rounded-lg shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-white border-b border-gray-200 p-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <BookmarkButton
              pageId={record.id}
              collectionName="Register of Free Persons - Jefferson"
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                {/* Citation */}
                <RecordCitation
                  collectionName="Register of Free Persons - Jefferson County"
                ...
                <RelatedRecords
                  ...
                  currentTable="register_free_persons_jefferson"
                  searchTerms={{
                    name: record.name || undefined,
      ...
      try {
        ...
        while (hasMore) {
          const { data, error } = await supabase
            ...
            .select("id, book_no, page_no, page_label, row_no, image_path, name, age, place_of_nativity, residence, entered_state_year, occupation, date_registered, created_at")
          ...
          if (error) {
            console.error("Error fetching Register Free Persons (Jefferson):", error);
            break;
          }
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Register of Free Persons - Jefferson County
            </h1>
            <p className="text-lg text-white/90">
              Records of free persons of color from Jefferson County, Georgia.
