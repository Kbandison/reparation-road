      ...
      <div className="bg-white rounded-lg shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-white border-b border-gray-200 p-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <BookmarkButton
              pageId={record.id}
              collectionName="Register of Free Persons - Baldwin"
          ...
          <div className="grid md:grid-cols-2 gap-8">
                ...
                >
                  ...
                  {isValidImageUrl(record.image_path) ? (
                    <Image
                      ...
                      alt={`${record.name} - Book ${record.book_no}, Page ${record.page_no}, Row ${record.row_no}`}
                      width={800}
                      height={1000}
                      className="w-full"
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                {(record.age_int !== null || record.age_text) && (
                  <div className="border-b border-gray-200 pb-3">
                    <p className="text-sm text-gray-600 mb-1">Age</p>
                    <p className="text-base text-gray-900">{record.age_int || record.age_text}</p>
                  </div>
                )}
...
const RegisterFreePersonsBaldwinPage = () => {
      ...
      try {
        ...
        while (hasMore) {
          const { data, error } = await supabase
            ...
            .select("id, book_no, page_no, row_no, slug, image_path, name, age_int, age_text, place_of_nativity, residence, date_entered_state, occupation, date_registered, created_at")
          ...
          if (error) {
            console.error("Error fetching Register of Free Persons (Baldwin):", error);
            break;
          }
  ...
  useEffect(() => {
    ...
    if (searchTerm) {
      ...
      filtered = filtered.filter(record =>
        ...
        (record.age_text && record.age_text.toLowerCase().includes(term)) ||
        ...
        (record.date_registered && record.date_registered.includes(term)) ||
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Register of Free Persons - Baldwin County
            </h1>
            <p className="text-lg text-white/90">
              Records of free persons of color from Baldwin County, Georgia.
              Browse historical register entries documenting free persons of color.
            </p>
          </div>
        </div>
      </div>
                    ...
                    {currentRecords.map((record, index) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-sm text-gray-900">
                          {record.age_int || record.age_text || "-"}
                        </td>
                        <td className="px-4 py-3 text-sm text-gray-900">
                          {record.residence || "-"}
                        </td>
...
const WrappedRegisterFreePersonsBaldwinPage = () => {
  return (
    <ProtectedRoute requiresPaid={true}>
      <Suspense fallback={
        ...
        <RegisterFreePersonsBaldwinPage />
      </Suspense>
    </ProtectedRoute>
  );
};

export default WrappedRegisterFreePersonsBaldwinPage;
