      ...
      <div className="bg-white rounded-lg shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-white border-b border-gray-200 p-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <BookmarkButton
              pageId={record.id}
              collectionName="Register of Free Persons - Lumpkin"
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <RelatedRecords
                  ...
                  currentTable="register_free_persons_lumpkin"
                  searchTerms={{
                    name: record.name || undefined,
    ...
    const fetchRecords = async () => {
      ...
      try {
        ...
        while (hasMore) {
          ...
          if (error) {
            console.error("Error fetching Register Free Persons (Lumpkin):", error);
            break;
          }
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Register of Free Persons - Lumpkin County
            </h1>
            <p className="text-lg text-white/90">
              Records of free persons of color from Lumpkin County, Georgia.
...
const WrappedRegisterFreePersonsLumpkinPage = () => {
  return (
...
export default WrappedRegisterFreePersonsLumpkinPage;
