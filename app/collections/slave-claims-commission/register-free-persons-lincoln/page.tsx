      ...
      <div className="bg-white rounded-lg shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-white border-b border-gray-200 p-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <BookmarkButton
              pageId={record.id}
              collectionName="Register of Free Persons - Lincoln"
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <RelatedRecords
                  ...
                  currentTable="register_free_persons_lincoln"
                  searchTerms={{
                    name: record.name || undefined,
...
const RegisterFreePersonsLincolnPage = () => {
    ...
    const fetchRecords = async () => {
      ...
      try {
        ...
        while (hasMore) {
          ...
          if (error) {
            console.error("Error fetching Register Free Persons (Lincoln):", error);
            break;
          }
  ...
  useEffect(() => {
    ...
    if (searchTerm) {
      ...
      filtered = filtered.filter(record =>
        ...
        (record.age && record.age.toLowerCase().includes(searchLower)) ||
        (record.place_of_nativity && record.place_of_nativity.toLowerCase().includes(searchLower)) ||
        (record.residence && record.residence.toLowerCase().includes(searchLower)) ||
        (record.occupation && record.occupation.toLowerCase().includes(searchLower)) ||
        (record.date_entered_state && record.date_entered_state.toLowerCase().includes(searchLower)) ||
        (record.date_registered && record.date_registered.toLowerCase().includes(searchLower))
      );
    }
  ...
  const handleRecordClick = useCallback((record: RegisterRecord) => {
    setSelectedRecord(record);
  }, []);
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Register of Free Persons - Lincoln County
            </h1>
            <p className="text-lg text-white/90">
              Records of free persons of color from Lincoln County, Georgia.
              Browse individual entries documenting names, ages, occupations, and residences.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8 space-y-4">
          <div className="flex flex-col sm:flex-row gap-4 items-center">
            <Input
              type="search"
              placeholder="Search by name, residence, occupation..."
              value={searchTerm}
                ...
                <table className="w-full">
                  <thead className="bg-brand-green text-white sticky top-0">
                    <tr>
                      ...
                      <th className="px-4 py-3 text-left text-sm font-semibold">Place of Nativity</th>
...
const WrappedRegisterFreePersonsLincolnPage = () => {
  return (
    <ProtectedRoute requiresPaid={true}>
      <Suspense fallback={
        ...
        <RegisterFreePersonsLincolnPage />
      </Suspense>
    </ProtectedRoute>
  );
};

export default WrappedRegisterFreePersonsLincolnPage;
