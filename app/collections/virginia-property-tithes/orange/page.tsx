      ...
      <div className="bg-white rounded-lg shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-white border-b border-gray-200 p-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <BookmarkButton
              pageId={record.id}
              collectionName="Virginia Personal Property & Tithes - Orange County"
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <RelatedRecords
                  ...
                  currentTable="va_personal_orange"
                  searchTerms={{
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Virginia Personal Property & Tithes - Orange County
            </h1>
            <p className="text-lg text-white/90">
              Historical personal property tax records from Orange County, Virginia listing enslaver families
...
const WrappedVaPersonalOrangePage = () => {
  return (
    <ProtectedRoute requiresPaid={true}>
      <Suspense fallback={
        ...
        <VaPersonalOrangePage />
      </Suspense>
    </ProtectedRoute>
  );
};

export default WrappedVaPersonalOrangePage;
