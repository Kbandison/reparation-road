      ...
      <div className="bg-white rounded-lg shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-white border-b border-gray-200 p-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <BookmarkButton
              pageId={page.id}
              collectionName="Virginia Order Books - Chesterfield"
...
const VirginiaOrderBooksChesterfieldPage = () => {
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Virginia Order Books - Chesterfield County
            </h1>
            <p className="text-lg text-white/90">
              Court proceedings and legal judgments documenting Negro adjudgments from Chesterfield County, Virginia.
                    ...
                    {currentPageData.map((page, index) => (
                      ...
                      >
                        <td className="px-4 py-3 text-sm text-gray-900 font-medium">
                          {page.page_label || `${page.page_no}${page.page_no_2 ? ` / ${page.page_no_2}` : ''}`}
                        </td>
...
const WrappedVirginiaOrderBooksChesterfieldPage = () => {
  return (
    <ProtectedRoute requiresPaid={true}>
      <Suspense fallback={
        ...
        <VirginiaOrderBooksChesterfieldPage />
      </Suspense>
    </ProtectedRoute>
  );
};

export default WrappedVirginiaOrderBooksChesterfieldPage;
