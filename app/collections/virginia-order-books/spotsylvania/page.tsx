...
const VirginiaOrderBooksSpottsylvaniaPage = () => {
...
const WrappedVirginiaOrderBooksSpottsylvaniaPage = () => {
  return (
    <ProtectedRoute requiresPaid={true}>
      <Suspense fallback={
        ...
        <VirginiaOrderBooksSpottsylvaniaPage />
      </Suspense>
    </ProtectedRoute>
  );
};

export default WrappedVirginiaOrderBooksSpottsylvaniaPage;
