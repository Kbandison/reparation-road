      ...
      <div className="bg-white rounded-lg shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-white border-b border-gray-200 p-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <BookmarkButton
              pageId={page.id}
              collectionName="Virginia Order Books - Spotsylvania"
              collectionSlug="virginia-order-books/spotsylvania"
              recordTitle={page.page_label || `Page ${page.page_no}`}
              size={24}
              showLabel={true}
            />
            <button
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <RelatedRecords
                  ...
                  currentTable="va_books_spotsylvania"
                  searchTerms={{
                ...
                <RecordCitation
                  collectionName="Virginia Order Books - Spotsylvania County"
                  recordIdentifier={page.page_label || `Page ${page.page_no || page.page_no_2 || 'Unknown'}`}
                  recordDetails={{
                    pageNo: page.page_no || undefined,
                    name: page.enslaved_person || undefined,
...
const VirginiaOrderBooksSpotsylvaniaPage = () => {
    ...
    const fetchPages = async () => {
      ...
      try {
        ...
        while (hasMore) {
          ...
          if (error) {
            console.error("Error fetching Virginia Order Books (Spotsylvania):", error);
            break;
          }
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Virginia Order Books - Spotsylvania County
            </h1>
            <p className="text-lg text-white/90">
              Court proceedings and legal judgments documenting Negro adjudgments from Spotsylvania County, Virginia.
...
const WrappedVirginiaOrderBooksSpotsylvaniaPage = () => {
  return (
    <ProtectedRoute requiresPaid={true}>
      <Suspense fallback={
        ...
        <VirginiaOrderBooksSpotsylvaniaPage />
      </Suspense>
    </ProtectedRoute>
  );
};

export default WrappedVirginiaOrderBooksSpotsylvaniaPage;
